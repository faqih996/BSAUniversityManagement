...
class TeacherController extends Controller
{
    ...
    public function index(): Response
    {
        ...
        return inertia('Admin/Teachers/Index', [
            'page_settings' => [
                'title' => 'Dosen',
                'subtitle' => 'Menampilkan semua data dosen yang terdaftar pada universitas ini.',
            ],
    ...
    {
        return inertia('Admin/Teachers/Create', props: [
            'page_settings' => [
                'title' => 'Tambah Dosen',
    ...
    {
        return inertia('Admin/Teachers/Edit', props: [
            'page_settings' => [
                'title' => 'Edit Dosen',
