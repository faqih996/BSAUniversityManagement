...
class TeacherOperatorController extends Controller
{
    ...
    public function index(): Response
    {
        ...
        return inertia('Operators/Teachers/Index', [
            'page_settings' => [
                'title' => 'Dosen',
                'subtitle' => "Menampilkan semua data dosen yang tersedia di {$faculty_name} dan Program Studi {$department_name}",
            ],
    ...
    {
        return inertia('Operators/Teachers/Create', props: [
            'page_settings' => [
                'title' => 'Tambah Dosen',
    ...
    {
        return inertia('Operators/Teachers/Edit', props: [
            'page_settings' => [
                'title' => 'Edit Dosen',
